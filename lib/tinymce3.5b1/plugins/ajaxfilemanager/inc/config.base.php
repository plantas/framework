...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', $_SESSION['AJAX_FILE_MANAGER_ROOT']); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', $_SESSION['AJAX_FILE_MANAGER_ROOT']);	//accept relative path only
